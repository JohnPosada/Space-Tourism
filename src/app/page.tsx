...
export default function Home() {
  return (
    <div className="h-full w-full grid grid-cols-2 grid-rows-5 place-items-center">
      <div className="row-span-full col-span-1 row-start-3">
      ...
      <div className="row-span-full row-start-4 col-span-1 rounded-full h-64 w-64 text-3xl font-sans flex justify-center items-center text-primary bg-white">
        EXPLORE
      </div>
    </div>
  );
